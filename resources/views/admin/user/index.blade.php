                                        ...
                                        <td
                                            ...
                                            <div class="flex gap-3">
                                                ...
                                                <form
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="rounded bg-blue-600 px-2 py-1 text-xs font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-red-500">Delete</button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
